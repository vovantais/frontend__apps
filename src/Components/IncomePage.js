				...
				<Container>
					...
					<Form onSubmit={handleSubmitForm}>
						<Form.Group >
							...
							<Form.Control type="number" name='sumIncome' placeholder="Enter sum" tabIndex='1' required step="1" min="1" pattern="^[ 0-9]+$"
								onChange={handleChangeIncome} value={userIncome.sumIncome} />
						</Form.Group>
						<Form.Group >
							...
							<Form.Control type='datetime-local' name='dateTimeIncome' tabIndex='2'
								min="2019-01-01T08:30" max="2030-01-30T16:30"
